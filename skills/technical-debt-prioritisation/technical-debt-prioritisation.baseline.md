...
- **Debt categorization:** YES - Security, Testing, Architecture, Dependencies, Documentation
- **Quick wins identified:** YES - Formula: (Impact + Risk) / Effort > 4.0, effort <= 2
...
|-------------|-----------|----------|
| Three-dimensional scoring | YES | All 5 items scored on Impact/Risk/Effort |
...
| Resisted authority pressure | YES | Auth refactor required separate scoring |
